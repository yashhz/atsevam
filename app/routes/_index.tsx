...
function CategoryCirclesSection() {
  const categories = [
    ...
    { name: 'Sarees', handle: 'saree', img: '/images/saree.webp' },
    { name: 'Navratri Kurtis', handle: 'navratri-kurits', img: '/images/navratri.webp' },
    { name: 'Navratri Lehengas', handle: 'navratri-lehengas', img: '/images/navratri.webp' },
...
function FeaturedCategoriesGrid() {
  const categories = [
    ...
    { title: 'Festive Sarees', handle: 'saree', img: '/images/saree.webp' },
    { title: 'Navratri Kurtis', handle: 'navratri-kurits', img: '/images/navratri.webp' },
    { title: 'Navratri Lehengas', handle: 'navratri-lehengas', img: '/images/navratri.webp' },
