...
function CategoryCirclesSection() {
  const categories = [
    ...
    { name: 'Sarees', handle: 'saree', img: '/images/saree.jpg' },
    { name: 'Navratri Kurtis', handle: 'navratri-kurits', img: '/images/navratri%20kurtis.jpg' },
    { name: 'Navratri Lehengas', handle: 'navratri-lehengas', img: '/images/navratri%20lehenga.jpg' },
